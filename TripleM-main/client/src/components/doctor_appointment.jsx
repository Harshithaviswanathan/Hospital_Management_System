    ...
    <div>
      ...
      {Array.isArray(appointments) && appointments.length > 0 ? (
        <table style={{ borderCollapse: 'collapse', width: '100%' }}>
          <thead>
            <tr>
              <th style={{ width: '25%', border: '1px solid #CCCCCC', fontSize: '0.95em', textAlign: 'center', padding: '8px' }}>Patient Name</th>
              <th style={{ width: '25%', border: '1px solid #CCCCCC', fontSize: '0.95em', textAlign: 'center', padding: '8px' }}>Appointment Time</th>
              <th style={{ width: '25%', border: '1px solid #CCCCCC', fontSize: '0.95em', textAlign: 'center', padding: '8px' }}>Appointment Type</th>
              <th style={{ width: '50%', border: '1px solid #CCCCCC', fontSize: '0.95em', textAlign: 'center', padding: '8px' }}>Appointment Reason</th>
            </tr>
          </thead>
          <tbody>
